...
# Esto funciona usando rutas globales: 
# bash scripts/eqpy_mmca-covid19.sh /home/javier/bsc/emews-mmca-covid19/model/run_simulations.jl /home/javier/bsc/emews-mmca-covid19/data /home/javier/bsc/emews-mmca-covid19/experiments/test20 /home/javier/bsc/emews-mmca-covid19/data/config.json
...
# MODEL_CMD="python"
JULIA_DEP=$(dirname ${executable_path})
MODEL_CMD="julia --project=${JULIA_DEP} ${executable_path}"

arg_array=("-d $data_path" "-i $instance_directory" "-c $config_path")
